...
import './full-source-pane.scss';

export interface FullSourcePaneProps {
  source: string;
  onSourceChange(newSource: string): void;
  onClose?: () => void;
}

export const FullSourcePane = React.memo(function FullSourcePane(props: FullSourcePaneProps) {
  ...
  return (
    <div className="full-source-pane">
      ...
      <div className="button-bar">
        ...
        />
        {onClose && <Button icon={IconNames.CROSS} minimal onClick={() => onClose()} />}
      </div>
    </div>
  );
});
